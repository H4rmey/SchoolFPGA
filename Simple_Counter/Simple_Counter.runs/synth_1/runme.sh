...
HD_PWD='C:/Users/hammi/Documents/GitBucket/SchoolFPGA/Simple_Counter/Simple_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FlipFlop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_FlipFlop.tcl
