...
HD_PWD='C:/Users/hammi/Documents/GitBucket/SchoolFPGA/Simple_Counter/Simple_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FlipFlop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T_FlipFlop.tcl -notrace
