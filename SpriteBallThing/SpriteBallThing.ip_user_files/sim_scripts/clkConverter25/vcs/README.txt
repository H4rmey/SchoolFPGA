...
#
# Generated by export_simulation on Mon Dec 17 20:23:39 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './clkConverter25.sh' script.

./clkConverter25.sh -reset_run
...
./clkConverter25.sh -noclean_files

For more information on the script, please type './clkConverter25.sh -help'.
