...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/bitbucket/SchoolFPGA/SpriteBallThing/SpriteBallThing.runs/clkConverter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkConverter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkConverter.tcl
