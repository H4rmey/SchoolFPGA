...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/hammi/OneDrive/Documenten/BitBucket/SchoolFPGA/4-bits adder/4-bits adder.runs/synth_1/FourBitAdder.dcp}}
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file FourBitAdder_timing_summary_routed.rpt -rpx FourBitAdder_timing_summary_routed.rpx -warn_on_violation "
