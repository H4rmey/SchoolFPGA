...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/bitbucket/SchoolFPGA/TestALU/TestALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_TB.tcl
