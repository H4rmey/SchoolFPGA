...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/bitbucket/SchoolFPGA/TestALU/TestALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_TB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_TB.tcl -notrace
