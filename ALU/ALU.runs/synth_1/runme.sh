...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/bitbucket/SchoolFPGA/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BinToBCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BinToBCD.tcl
