...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/BitBucket/SchoolFPGA/BCDCounter/BCDCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_OUTPUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_OUTPUT.tcl
