...
HD_PWD='C:/Users/hammi/OneDrive/Documenten/BitBucket/SchoolFPGA/BCDCounter/BCDCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_OUTPUT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_OUTPUT.tcl -notrace
